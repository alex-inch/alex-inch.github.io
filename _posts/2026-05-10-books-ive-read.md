...
There are plenty of interesting diversions on perception and consciousness.  Like, many people might know that cephalopods can change colour to camouflage themselves, or communicate to other animals. But how's this? They're colour blind too. We don't even know for sure how they perceive colour to hide themselves --- maybe the shape of their eyes induces chromatic aberration, or the skin itself can detect colour.

On consciousness, *Other Minds* discusses the idea of distributed intelligence. The analogy Godfrey-Smith uses is that of a rowing boat, with the crew swinging in sync with one another. Here's an example: most animals' brains have two halves. But humans are quite exceptional in how interconnected they are. If you teach a pigeon to solve a puzzle with only the left half of its brain, the right half doesn't learn how to do it (you teach half a brain by covering up the eyes, apparently). So what is the perception of that pigeon like, if there isn't a reconciled view of its surroundings?

Similarly, cephalopod neurons communicate more slowly than ours, so a lot of decision-making is distributed throughout the body. Their central brain doesn't tell the arm to move; the arm moves, and lets the brain know it's happening (via an 'efference copy' of the command to move). What if some of what we tell ourselves we do, is actually this kind of process in action? How much of our conception of a central conscious *self* is just a fiction constructed by different parts of our brain working in concert? Much to ponder…

Lastly, there's one line that really stood out to me. There's a drive in robotics to work on VLAs --- basically LLMs like ChatGPT which have been tweaked to interact with the world. Here's Godfrey-Smith on the role of language in human cognition: *Language is an important tool for thought, and inner speech is not mere mental-acoustic froth. But it is not essential to the organisation of ideas, and language is not **the** medium of complex thought.* That matches my own intuition --- language is an important part of our intelligence, but it's not the whole thing. And there's a lot of physical intelligence exhibited by animals with hardly any language at all. That's not to say VLAs are a dead end, but I do think there's something missing.

In sum: it's a good book, great food for thought, lovely images, would recommend.
...
<!-- - Language is an important tool for thought, and inner speech is not mere mental-acoustic froth. But it is not essential to the organisation of ideas, and language is not *the* medium of complex thought. -->
...
Demis Hassabis --- the subject of *Infinity Machine* --- is the only CEO of an AI lab that can credibly claim he's actually made progress in that direction. His AI lab, DeepMind, released the protein folding model AlphaFold, as well as making contributions in other domains like weather prediction and nuclear fusion. As someone in research, I think it'd be hard to do much better than Hassabis.

The book runs through Hassabis's life, charting his childhood as a chess prodigy, his discovery of AI as student, and later wheelings-and-dealings in the halls of power at Google. Over time, though, the focus sags. Mallaby has researched the book over the course of many interviews with central figures in modern AI. There's a lot of information, but he crams in everything, even if it distracts: You get Elon Musk's tantrums at OpenAI, Sam Altman's ouster, Mustafa Suleyman's departure from DeepMind, John Jumper's time at DE Shaw Research, and more...

The other main issue is that the book barely interrogates its subjects. Hassabis says he's only interested in scientific truth, not power or money. That may be true, but he does seem to have accrued a lot of power and money along the way --- only lightly probed. He also has a clear competitive streak that may open up some blind spots, which Mallaby could have dug into more. Now that he's [stepped back from DeepMind](https://www.theguardian.com/technology/2026/aug/05/big-shake-up-in-googles-ai-team-as-deepmind-chief-executive-steps-down), the proof will be in what he does next. Hopefully something a bit more interesting than LLMs: *'Right now everyone's just caught in the frenzy of "can we make the foundation model 10% better?" The other things we should be think about are receding into the distance.'*

And anyway, I told a fib. The *greatest* sin committed in *Infinity Machine* isn't that it lacks focus, or is a bit of a hagiography. It's that the writing peaks at functionally dull and plummets to outright irritating. My Mum walked past while I was listening to it in the kitchen and asked what that 'boring load of shite' was. And worse, Mallaby has invented this stupid, grandiose term for AI which he insists on using constantly: the 'infinity machine.' The book is all *'infinite this'*, *'infinite that'*, *'an infinity of possibilities'*. Does it convey anything useful? Maybe only the infinite patience Mallaby expects of his reader (hahahaaaaaa zing!).

Anyway, in conclusion: the book is fine. I doubt many people would make it through this book without a prior interest in the subject. I got through it because I'm a fan of Hassabis. But in general, I'd say it's just fine. Get it if you're interested in Hassabis, AI, or Silicon Valley entrepreneurship. Skip otherwise.
